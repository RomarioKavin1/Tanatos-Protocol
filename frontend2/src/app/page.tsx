...
const features = [
  {
    ...
    description:
      "ZK-proofs ensure your check-ins remain indistinguishable from the void. Complete anonymity.",
  },
  {
    title: "The River Styx",
    description:
      "A unidirectional flow. Funds are locked securely in Cairo smart contracts until conditions are met.",
  },
  {
    title: "Hypnos' Threshold",
    description:
      "Set your interval. When sleep becomes permanent, the threshold breaks and transmission begins.",
  },
  {
    title: "Obol Distribution",
    description:
      "Automated, cryptographically secured transfer of assets to your chosen beneficiary payload.",
  },
];
...
const steps = [
  {
    step: "[01]",
    title: "SEVERANCE.",
    description: "Generate your secure Semaphore identity. Disconnect your identity from your keys.",
  },
  {
    step: "[02]",
    title: "PACT.",
    description: "Deposit assets into your vault. Encrypt the beneficiary payload.",
  },
  {
    step: "[03]",
    title: "PULSE.",
    description: "Prove you exist. Periodically check in using zero-knowledge proofs.",
  },
  {
    step: "[04]",
    title: "SILENCE.",
    description: "When the pulse stops, the vault unlocks. The legacy transfers.",
  },
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-24">
            {steps.map((item, i) => (
              <div key={i} className="border-t border-card-border pt-8 group">
                ...
                <p className="text-muetd-foreground max-w-md text-lg leading-relaxed">
                  {item.description}
                </p>
              </div>
            ))}
      ...
      <footer className="pt-24 pb-8 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-card-border text-xs font-mono text-muted-foreground uppercase">
            <p>&copy; 2025 Thanatos Protocol. All rights reserved.</p>
